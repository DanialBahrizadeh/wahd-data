...
export async function getSession(sessionStore: MemoryStore, sessionId: string): Promise<Session | null> {
...
export async function setSession(sessionStore: MemoryStore, session: Session, sessionId: string) {
